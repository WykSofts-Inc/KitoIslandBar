...
3. Make your change. Follow
   [KitoIslandBar's engineering standards](https://github.com/WykSofts-Inc/KitoIslandBar/blob/main/docs/ENGINEERING_STANDARDS.md) —
